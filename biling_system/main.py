...
class Bill_App:
    def __init__(self,root):
        ...
        bill_btn = Button(F1,text="Search", command = self.find_bill,  width=10, bd=7, font=('arial', 12, 'bold'), relief=GROOVE)
        ...
        F2.place(x=5, y=180, relwidth=325, height=380)
    ...
    def welcome_bill(self):
            ...
            self.textarea.insert(END, "\tWelcome MB Retail")
    ...
    #=========savebill============================
    def save_bill(self):
        cp = messagebox.askyesno("Bill", "Save Bill?")
        if cp > 0:
    ...
    # ======================clear-bill======================
    def clear_data(self):
        cp = messagebox.askyesno("Clear", "Do you really want to Clear?")
